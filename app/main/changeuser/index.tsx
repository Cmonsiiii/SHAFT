...
const VerifyEmail = () =>{
    ...
    const handleOTPAlert = () => {
        setOTPAlert((prev: any) => ({ ...prev, visible: false }));
    ...
    const handleVerificationAlert = () => {
        setVerificationAlert((prev: any) => ({ ...prev, visible: false }));
        if (verificationAlert.iconColor === "success") {
            router.replace("./changeUser");
        }
    };
            ...
            <View style={style.middle}>
                <View style={style.msg}>
                    <ThemedText type="fade">
                        To change your current username in your account, you need to verify your identity first. Click "Send Verification Code" to receive a One-Time PIN password at your email.
                    </ThemedText>
                </View>
